...
BUILT_IN_AGENT_TYPES = ("planner", "developer", "tester", "documentation", "review", "recovery", "investigator", "defect")
...
def build_planner_prompt(spec_text: str) -> str:
    return (
        ...
        "Always create exactly one shared tester bead, one shared documentation bead, and one shared review bead as children of the feature bead \u2014 never omit any of these three types. "
        "Do not create per-developer tester, documentation, or review children. "
