...
def build_planner_prompt(spec_text: str) -> str:
    return (
        ...
        "Keep developer implementation beads narrowly scoped as single focused changes that should fit within roughly 10 minutes of implementation work. "
        ...
        "When a feature needs multiple related developer beads, create shared tester, documentation, and review follow-up beads rather than duplicating that work in each implementation bead. "
